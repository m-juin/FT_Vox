		...
		namespace Rendering
		{
			namespace Images
			{
											 ...
											 VkMemoryPropertyFlags properties)
				{
					...
					if (vkCreateImage(this->_device->GetLogicalDevice(), &imageInfo, nullptr, &this->_image) !=
						VK_SUCCESS)
					...
					allocInfo.memoryTypeIndex = Utils::Buffer::FindMemoryType(
						memRequirements.memoryTypeBits, properties, this->_device->GetPhysicalDevice());

					if (vkAllocateMemory(this->_device->GetLogicalDevice(), &allocInfo, nullptr, &this->_memory) !=
						VK_SUCCESS)
					{
				...
				void DepthImage::CreateSampler()
				{
					...
					if (vkCreateSampler(this->_device->GetLogicalDevice(), &samplerInfo, nullptr, &this->_sampler) !=
						VK_SUCCESS)
