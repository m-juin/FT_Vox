...
namespace Vox::Front::Rendering::Pipelines
{
	...
	void TransparentVoxelPipeline::CreatePipeline()
	{
		auto vertShaderCode = Vox::Utils::Files::ReadFile("Shaders/TransparentVoxel/Shader.vert.spv");
		auto fragShaderCode = Vox::Utils::Files::ReadFile("Shaders/TransparentVoxel/Shader.frag.spv");
	...
	void TransparentVoxelPipeline::InitSet(std::vector<VkBuffer> buffers, VkDeviceSize size)
	{

		auto &texturesManager = Game::GameManager::GetInstance().GetTexturesManager();
		auto textureAtlas =
			static_cast<Front::Utils::MaskedTexturesAtlas *>(texturesManager.operator[]("A_Blocks_Transparent"));
	...
	void TransparentVoxelPipeline::CreateSet(VkDescriptorPool &descPool)
	{
	...
	void TransparentVoxelPipeline::CreateSetLayout()
	{
