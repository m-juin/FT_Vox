		...
		namespace Rendering
		{
			namespace Utils
			{
				namespace Buffer
				{
					...
					inline void CreateBuffer(VkDevice logicalDevice, VkPhysicalDevice phDevice, VkDeviceSize size, VkBufferUsageFlags usage,
											 ...
											 VkDeviceMemory &bufferMemory)
					{
						...
						allocInfo.memoryTypeIndex =
							FindMemoryType(memRequirements.memoryTypeBits, properties, phDevice);
					...
					inline void EndSingleTimeCommands(VkCommandBuffer &commandBuffer, VkDevice &device, VkCommandPool &pool, VkQueue &grQueue)
					{
					...
					inline void CopyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size, VkDevice device, VkCommandPool &pool, VkQueue &grQueue)
					{
