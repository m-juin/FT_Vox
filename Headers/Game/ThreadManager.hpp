...
namespace Vox::Game
{
	...
	class ThreadManager
	{
		...
		public:
			...
			void EnQueue(std::function<void(std::unordered_map<std::string, std::pair<const Spline::Spline, float>>, std::vector<Game::Datas::Textures::TextureInfo>, std::vector<Game::Datas::Textures::TextureInfo>)> newTask);
			void RecreatePool();
		...
		private:
			...
			std::queue<std::function<void(std::unordered_map<std::string, std::pair<const Spline::Spline, float>>, std::vector<Game::Datas::Textures::TextureInfo>, std::vector<Game::Datas::Textures::TextureInfo>)>> _tasks;
			/* private */
	};
} // namespace Vox::Game
